...
# Sort the bed file by chromosome, and then by index (some files such as CUT&RUN may be out of order)
...
# Eliminate any non-standard chromsomes using the reference genome file to form a standard bed file.
