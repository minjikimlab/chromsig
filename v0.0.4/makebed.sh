...
# using bedtools, convert bam input to bed file (this runs only if the input was a bam file)
# For Single End, do a direct conversion.
# For Paired End, eliminate any unpaired reads, and only convert paired reads to bed file format.
