...
function usage
{
    ...
    sbatch multijob_bam2freq_enrich_bg.sh --bamorbed input_file --dir data_directory --r ref --fdr fdr --num samp_size --type str_type --cov coverage --lib lib_name --plot true --modload true
        ...
        EXAMPLE:
            sbatch multiscript_bam2freq_enrich_bg.sh --bamorbed GM12878_ATAC-seq_ENCFF415FEC.bam --dir /nfs/turbo/umms-minjilab/njgupta/chromsig/ATAC-seq_PE/ --r hg38 --fdr 0.1 --num 5000 --type PE --cov 0.02"
}
